...
import com.bigdata.locationweibo.thread.CrawlerThread;
...
public class ControlFrame extends JFrame{
	 ...
	 * @author ChenZhiling
	 */
	private static final long serialVersionUID = -6575607920239846307L;
    ...
    public ControlFrame(CookieStore cookieStore) {
    ...
    private void initThread() {
        ...
        crawlerThread.setCookieStore(cookieStore);
	}
    ...
    private void initListener()
    {
        startButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                crawlering();
                crawlerThread.setDir(fileChooser.getSelectedFile().getParent()+"\\");
                crawlerThread.setPathload(fileChooser.getSelectedFile().getName());
                retriveThread = new Thread(crawlerThread);
                retriveThread.start();
            }
        ...
        getCSVButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				SaveCSVThread csvThread = new SaveCSVThread(fileChooser.getSelectedFile().getParent()+"\\", 
						fileChooser.getSelectedFile().getName(), 
						savename.getText().toString());
				saveCSVThread = new Thread(csvThread);
				saveCSVThread.start();
				getCSVButton.setEnabled(false);
